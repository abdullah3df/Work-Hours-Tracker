...
export const ShiftStartIcon = (props) => (
...
export const ShiftEndIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
...
export const LanguageIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
    React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C13.18 7.061 14.12 7 15 7c.878 0 1.797.06 2.666.164m-4.332-1.804A48.567 48.567 0 0112 3c1.12 0 2.233.038 3.334.114M12 3v2.25" })
  )
);

export const GlobeAltIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
    React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.358 0 2.662-.331 3.757-.934m-7.514 0A9.006 9.006 0 0112 3c1.358 0 2.662.331 3.757.934m-7.514 0a9.006 9.006 0 00-3.757 6.319M12 3c-1.358 0-2.662-.331-3.757.934m7.514 0A9.006 9.006 0 0112 21c-1.358 0-2.662-.331-3.757-.934M3.375 7.5a9.008 9.008 0 0017.25 0M3.375 7.5c0-1.02.194-2.004.558-2.915M20.625 7.5c0-1.02-.194-2.004-.558-2.915m0 0A9.003 9.003 0 0012 3c-1.63 0-3.19.423-4.5.115M12 12.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-.008z" })
  )
);
...
export const SunIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
    React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-6.364-.386l1.591-1.591M3 12h2.25m.386-6.364l1.591 1.591M12 12a4.5 4.5 0 000 9 4.5 4.5 0 000-9zm-4.5 4.5a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0z" })
  )
);

export const GoogleIcon = (props) => (
  React.createElement('svg', { viewBox: "0 0 48 48", ...props },
    React.createElement('path', { fill: "#FFC107", d: "M43.611,20.083H42V20H24v8h11.303c-1.649,4.657-6.08,8-11.303,8c-6.627,0-12-5.373-12-12	c0-6.627,5.373-12,12-12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657C34.046,6.053,29.268,4,24,4C12.955,4,4,12.955,4,24	s8.955,20,20,20s20-8.955,20-20C44,22.659,43.862,21.35,43.611,20.083z" }),
    React.createElement('path', { fill: "#FF3D00", d: "M6.306,14.691l6.571,4.819C14.655,15.108,18.961,12,24,12c3.059,0,5.842,1.154,7.961,3.039l5.657-5.657	C34.046,6.053,29.268,4,24,4C16.318,4,9.656,8.337,6.306,14.691z" }),
    React.createElement('path', { fill: "#4CAF50", d: "M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36	c-5.223,0-9.657-3.657-11.303-8.309l-6.522,5.025C9.505,39.556,16.227,44,24,44z" }),
    React.createElement('path', { fill: "#1976D2", d: "M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238	C42.022,35.421,44,30.036,44,24C44,22.659,43.862,21.35,43.611,20.083z" })
  )
);
...
export const ImageIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
    React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5z" }),
    React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M12.75 8.25h.008v.008h-.008V8.25z" })
  )
);

export const FlagENIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 60 30", ...props },
    React.createElement('clipPath', { id: "s" }, React.createElement('path', { d: "M0,0 v30 h60 v-30 z" })),
    React.createElement('path', { d: "M0,0 v30 h60 v-30 z", fill: "#012169" }),
    React.createElement('path', { d: "M0,0 L60,30 M60,0 L0,30", stroke: "#fff", strokeWidth: "6", clipPath: "url(#s)" }),
    React.createElement('path', { d: "M0,0 L60,30 M60,0 L0,30", stroke: "#C8102E", strokeWidth: "4", clipPath: "url(#s)" }),
...
export const FlagARIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 900 600", ...props },
    React.createElement('rect', { width: "900", height: "600", fill: "#fff" }),
    React.createElement('rect', { width: "900", height: "200", fill: "#000" }),
    React.createElement('rect', { y: "400", width: "900", height: "200", fill: "#007a3d" }),
    React.createElement('path', { d: "M450,400 L250,300 L450,200 z", fill: "#ce1126" })
  )
);

export const FlagDEIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 5 3", ...props },
    React.createElement('rect', { id: "black_stripe", width: "5", height: "3", y: "0", x: "0", fill: "#000" }),
    React.createElement('rect', { id: "red_stripe", width: "5", height: "2", y: "1", x: "0", fill: "#D00" }),
    React.createElement('rect', { id: "gold_stripe", width: "5", height: "1", y: "2", x: "0", fill: "#FFCE00" })
  )
);
...
export const ChevronDoubleRightIcon = (props) => (
  React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
    React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M5.25 4.5l7.5 7.5-7.5 7.5m6-15l7.5 7.5-7.5 7.5" })
  )
);
...
export const SparklesIcon = (props) => (
    React.createElement('svg', { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", ...props },
        React.createElement('path', { strokeLinecap: "round", strokeLinejoin: "round", d: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 21.75l-.648-1.188a2.25 2.25 0 01-1.423-1.423L13.25 18.5l1.188-.648a2.25 2.25 0 011.423-1.423L16.25 15.25l.648 1.188a2.25 2.25 0 011.423 1.423l.938 1.714-1.714.938a2.25 2.25 0 01-1.423 1.423z" })
    )
);